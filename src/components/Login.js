...
import MyImageSvg from '../assets/images/undraw_referral_4ki4.svg';
        ...
        <div className="phone-app-2">
            <div className="container-bot">
                ...
                <div className="image-intro-big">
                    ...
                    <div className="text-block-21">Keep in touch, <strong className="bold-black">always Without minding</strong>
                    </div>
                </div>
                <div className="import-contact">
                    ...
                    <a href="login-with-email.html" className="button_main-2 m-b-10 w-button">email address Connect</a>
